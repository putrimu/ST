<?php namespace App\Http\Controllers;
	...
	class AdminDatawargaController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->col[] = ["label"=>"Fingger","name"=>"fingger"];
			$this->col[] = ["label"=>"Alamat","name"=>"alamat"];
			$this->col[] = ["label"=>"Rt","name"=>"id_rt","join"=>"datart,kode_rt"];
			...
			$this->form[] = ['label'=>'Fingger','name'=>'fingger','type'=>'text','validation'=>'required|min:1|max:255','width'=>'col-sm-10'];
			$this->form[] = ['label'=>'Alamat','name'=>'alamat','type'=>'textarea','validation'=>'required|string|min:5|max:5000','width'=>'col-sm-10'];
			$this->form[] = ['label'=>'Rt','name'=>'id_rt','type'=>'select2','validation'=>'required|integer|min:0','width'=>'col-sm-10','datatable'=>'datart,kode_rt'];
			...
			//$this->form[] = ["label"=>"Fingger","name"=>"fingger","type"=>"text","required"=>TRUE,"validation"=>"required|min:1|max:255"];
			//$this->form[] = ["label"=>"Alamat","name"=>"alamat","type"=>"textarea","required"=>TRUE,"validation"=>"required|string|min:5|max:5000"];
			//$this->form[] = ["label"=>"Rt","name"=>"id_rt","type"=>"select2","required"=>TRUE,"validation"=>"required|integer|min:0","datatable"=>"rt,id"];
			# OLD END FORM
