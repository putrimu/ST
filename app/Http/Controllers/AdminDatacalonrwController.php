<?php namespace App\Http\Controllers;
	...
	class AdminDatacalonrwController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->form[] = ['label'=>'Rw','name'=>'id_rw','type'=>'select2','validation'=>'required|integer|min:0','width'=>'col-sm-10','datatable'=>'datarw,kode_rw'];
			...
			//$this->form[] = ["label"=>"Rw","name"=>"id_rw","type"=>"select2","required"=>TRUE,"validation"=>"required|integer|min:0","datatable"=>"rw,id"];
			# OLD END FORM
